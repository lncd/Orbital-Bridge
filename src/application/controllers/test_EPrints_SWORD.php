...
class Test_EPrints_SWORD extends CI_Controller {
	...
	function index()
	{
		...
		$testurl = "http://eprints.lincoln.ac.uk/sword-app/servicedocument";
		...
		$testdepositurl = "https://eprints.lincoln.ac.uk/id/contents";

		// The test file to deposit
		$testfile = "/Users/hnewton/Desktop/TEST.txt.zip";
		...
		require("application/libraries/swordapp-php-library-1.0/swordappclient.php");
