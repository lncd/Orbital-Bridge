...
class Sword {
	...
	function input_to_ePrints($username = "sword-test", $password = "sword-test")
	{
		...
		$archive = file_get_contents("/Users/hnewton/Desktop/test-import.xml");
		...
		curl_setopt($ch,CURLOPT_POST, strlen($archive));
		curl_setopt($ch,CURLOPT_POSTFIELDS, $archive);
