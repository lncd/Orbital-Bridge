<div class="page-header">
	...
	<h1>
		<i class="icon-plus"></i> Start a Research Project
	</h1>
...
<div class="row">
	...
	<div class="span12">
		...
		<div class="alert alert-block alert-info">
			<h4>Funded Project?</h4>
			<p>If you're starting a new funded project, you should instead use the University's <a href="http://ams.lincoln.ac.uk">Award's Management System</a>. Once your project is created using the AMS it's easy to import it back into Orbital.</p>
		</div>
