...
<div class="row">
	...
	<?php 
		...
		foreach($dataset['research_project']['research_project_members'] as $project_member)
		{
			...
			echo '<tr id="member_row_' . $member_id . '"><td>' . $title . $project_member['person']['first_name'] . ' ' . $project_member['person']['last_name'] . '<input type="hidden" name="members[' . $member_id . '][id]" value="' . (int) $project_member['person']['employee_id'] . '"><input type="hidden" name="members[' . $member_id . '][name]" value="' . $project_member['person']['first_name'] . ' ' . $project_member['person']['last_name'] . '"></td><td><select name="members[' . $member_id . '][permission]">';
