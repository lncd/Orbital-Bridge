...
<div class="row">
	...
	echo '<div class="controls">';
	echo form_dropdown('page_type', $page_type, set_value('page_type', $page_data->mode), 'id="page_type"');
	...
	$form_git_page = array(
		'name'			=> 'page_git_page',
		'id'			=> 'page_git_page',
		'value'			=> set_value('page_git_page', $page_data->git_page),
		'maxlength'		=> '100',
		'class'			=> 'input-large'
	);
	...
	$form_git_page = array(
		...
		'value'			=> set_value('page_redirect_uri', $page_data->redirect_uri),
		'class'			=> 'input-xlarge'
	);
