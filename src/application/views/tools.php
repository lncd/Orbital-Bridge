...
<div class="row">
	...
	<div class="span6">
		...
		<p><a class="btn" href="https://ckan.lincoln.ac.uk/"><i class="icon-chevron-right"></i> Go to CKAN</a> <a href="<?php echo site_url('contact'); ?>" class="btn"><i class="icon-chevron-right"></i> Contact us about CKAN</a></p>
